...
<body>
	<div class="container-fluid">
		<div class="container mx-auto mt-4">
			...
			<hr />
			<a href="/events/new">Post an Event</a> <a href="/logout">Log Out</a>
		</div>
	</div>
	...
	<main>
		<div class="d-flex flex-column flex-shrink-0 p-4 text-white bg-dark"
			...
			<ul class="nav nav-pills flex-column mb-auto">
				...
				<li><a href="/dashboard" class="nav-link text-white"> <svg
							class="bi me-2" width="16" height="16">
							<use xlink:href="#speedometer2"></use></svg> Dashboard
				</a></li>
				<li><a href="/about" class="nav-link text-white"> <svg
							class="bi me-2" width="16" height="16">
							<use xlink:href="#table"></use></svg> About
				</a></li>
				<li><a href="contacts" class="nav-link text-white"> <svg
							class="bi me-2" width="16" height="16">
							<use xlink:href="#grid"></use></svg> Contact
				</a></li>
				<li><a href="events" class="nav-link text-white"> <svg
							class="bi me-2" width="16" height="16">
							<use xlink:href="#people-circle"></use></svg> Events
				</a></li>
			</ul>
			<hr>
